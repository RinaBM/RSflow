      ...
      <aside className="flex w-60 shrink-0 flex-col border-r border-border bg-card">
        ...
        <div className="space-y-1 border-t border-border px-3 py-3">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 rounded-md border-l-2 border-transparent px-3 py-2 text-sm font-medium text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground"
          >
